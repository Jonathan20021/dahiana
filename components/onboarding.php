    ...
    const TOURS_CLIENT = {
        overview: {
            ...
            steps: () => [
                ...
                { element: '[data-tour="nav-uploads"]', popover: { title: 'Subir facturas', side: 'right',
                    description: 'Toma fotos a tus facturas. Leemos el RNC, NCF, ITBIS y monto automaticamente.' } },
        ...
        upload: {
            ...
            color: 'indigo',
            steps: () => [
                { popover: { title: 'Subir facturas',
                    description: 'Toma una foto bien iluminada a tu factura, subela y leemos todo. Tu asesor solo valida.' } },
